        ...
        sections={[
          {
            ...
            list: [
              "필수 항목: 성명(단체명), 생년월일, 연락처, 이메일",
              "선택 항목: 소속, 직위, 전공 악기, 활동 지역",
              "이용 목적: 회원 자격 확인 및 관리, 행사·교육 안내, 회비 납부 안내",
              "만 14세 미만인 경우: 법정대리인의 성명·연락처 (동의 확인 목적)",
            ],
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "가입 신청 시 생년월일로 연령을 확인하며, 만 14세 미만인 경우 법정대리인의 성명·연락처와 동의 여부를 함께 받습니다. 법정대리인의 정보는 동의 확인 목적으로만 이용하고 다른 용도로 쓰지 않습니다.",
